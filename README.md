...
- 推奨修正方針は、まずVercel Project SettingsでFramework PresetをNext.jsに明示し、Git連携Preview deploymentを作り直すことです。
