...
- Preview DBにはStep G smokeの検証データが残っているため、10人テスト候補へ共有する前にcleanup / reset方針を決める
