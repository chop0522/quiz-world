...
### A. Phase 8 10-user local smoke / ops rehearsal計画

- 10人テスト前のlocal smoke / ops rehearsal範囲を整理する。
- signup、question authoring、launch、answer、result、rating/report、rank_events、admin moderationの一連の運用確認を計画する。
...
Phase 1〜7 local実装は完了・push・tag済み。次はPhase 8 10-user local smoke / ops rehearsal計画へ進むか判断する。
