...
Phase 10は一般公開ではない。Production環境でもない。Preview URL共有範囲はowner/adminから開始し、信頼できる1〜2名、最大10名へ段階的に広げる。
...
信頼できる1〜2名へ広げる段階から、参加者別invite codeをadmin画面で発行する方針を推奨する。
...
- 最初に共有する信頼できる1〜2名
- 不具合報告窓口
- owner/admin確認後に使うinvite code方針
